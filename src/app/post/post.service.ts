...
export class PostService {
  ...
  getLinkMetadata(url: string): Observable<any> {
    ...
    return this.http.post(this.apiUrlLink, { url });
    /*
  ...
  createPost(payload: any): Observable<any> {
    return this.http.post(this.createPostUrl, payload);
    /*.pipe(
 ...
 getPosts(searchTerm: string = ''): Observable<any> {
  // Nếu searchTerm trống, API sẽ là .../posts
  // Nếu có searchTerm, API sẽ là .../posts?search=keyword
